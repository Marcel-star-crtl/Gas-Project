...
//   const featuredImageUrl = article.featuredImage?.node?.sourceUrl || '/default-image.jpg'; 

//   return (
//     <section className="mx-auto py-12 section__padding" style={{ paddingTop: "8rem" }}> 
...
const ArticlePage = () => {
  ...
  return (
    <section className="mx-auto py-12 section__padding" style={{ paddingTop: "8rem" }}> 
      ...
      <div className="padding__mobile mx-auto py-8 section__padding">
        <div className="flex items-center" style={{ padding: "0 0" }}>
          <p className="mr-4" style={{ width: "300px", fontWeight: "700px", fontSize: "20px" }}>
      ...
      <div className="flex items-center" style={{ padding: "0 4rem" }}>
        <button 
          className="mr-4 bg-transparent border border-gray-500 rounded-md px-4 py-2" 

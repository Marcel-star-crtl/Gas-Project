...
export default function PostDetails() {
  ...
  return (
    <section className="mx-auto py-20 section__padding" style={{ paddingTop: "8rem" }}>
      <div className="text-start">
        <h1 className="text-2xl md:text-4xl mb-4" style={{ fontFamily: "Montserrat-Bold" }}>
          {post.title}
        </h1>
      </div>
      <div
      ...
      <div
        className="padding__mobile post-content w-full md:px-0 mt-20 py-6 text-lg"
        style={{ padding: "0 4rem 4rem 4rem", lineHeight: "1.3", fontSize: "16px" }}
        dangerouslySetInnerHTML={{ __html: post.content }}
      ></div>
      <div className="mx-auto py-8">
        <div className="padding__mobile flex items-center" style={{ padding: "0 0" }}>
          <p className="mr-4" style={{ width: "200px", fontWeight: "700px", fontSize: "20px" }}>
            Press Releases
          </p>
          <div className="w-full h-px bg-gray-300 items-end align-bottom"></div>
        </div>
      ...
      <div className="padding__mobile flex items-center" style={{ padding: "0 0" }}>
        <button 
          className="text__btn mr-4 bg-transparent border border-gray-500 rounded-md text-sm px-4 py-2" 
          style={{ background: "#1065C2", color: "#fff", width: "200px", fontWeight: "700", fontSize: "16px" }}
        >
          All press releases
        </button>
        <div className="w-full h-px bg-gray-300 items-end align-bottom"></div>
